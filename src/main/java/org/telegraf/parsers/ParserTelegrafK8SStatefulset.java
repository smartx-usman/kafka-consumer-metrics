...
public class ParserTelegrafK8SStatefulset implements parsable {
    ...
    public ParserTelegrafK8SStatefulset(Storable data_store) {
        data_store_class = data_store;
        store_record_file = new StoreRecordFile("kubernetes_statefulset");
    }
    ...
    public void parse_record(ConsumerRecord<String, String> record, String es_index) {
        try {
            ...
            if (statefulset_name[1].equals("loki")) {
                logger.warn("Loki Record Timestamp: " + instant);
            }
