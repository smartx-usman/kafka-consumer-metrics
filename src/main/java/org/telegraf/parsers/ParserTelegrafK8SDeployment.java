...
public class ParserTelegrafK8SDeployment implements parsable {
    ...
    private final File file = new File("/metrics/kubernetes_deployment.json");
    private final ObjectMapper mapper = new ObjectMapper();
    private FileWriter file_writer = null;
    private SequenceWriter sequence_writer = null;

    public ParserTelegrafK8SDeployment(StoreRecordES es, StoreRecordPrometheus prometheus) {
        store_record_es = es;
