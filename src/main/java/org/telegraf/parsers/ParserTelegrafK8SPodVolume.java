...
public class ParserTelegrafK8SPodVolume implements parsable {
    ...
    private final File file = new File("/metrics/kubernetes_pod_volume.json");
    private final ObjectMapper mapper = new ObjectMapper();
    private FileWriter file_writer = null;
    private SequenceWriter sequence_writer = null;

    public ParserTelegrafK8SPodVolume(StoreRecordES es, StoreRecordPrometheus prometheus) {
        store_record_es = es;
