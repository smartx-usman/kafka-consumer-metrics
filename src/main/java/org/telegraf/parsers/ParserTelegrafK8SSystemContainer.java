...
public class ParserTelegrafK8SSystemContainer implements parsable {
    ...
    private final File file = new File("/metrics/kubernetes_system_container.json");
    private final ObjectMapper mapper = new ObjectMapper();
    private FileWriter file_writer = null;
    private SequenceWriter sequence_writer = null;

    public ParserTelegrafK8SSystemContainer(StoreRecordES es, StoreRecordPrometheus prometheus) {
        store_record_es = es;
