...
public class ParserTelegrafK8SDaemonset implements parsable {
    private static final Logger logger = LogManager.getLogger(ParserTelegrafK8SDaemonset.class);
    private final StoreRecordES store_record_es;
    private final StoreRecordPrometheus store_record_prometheus;
    private final File file = new File("/metrics/kubernetes_daemonset.json");
    private final ObjectMapper mapper = new ObjectMapper();
    private FileWriter file_writer = null;
    private SequenceWriter sequence_writer = null;

    public ParserTelegrafK8SDaemonset(StoreRecordES es, StoreRecordPrometheus prometheus) {
        store_record_es = es;
    ...
    public void parse_record(ConsumerRecord<String, String> record, String es_index) {
        try {
            ...
            String[] daemonset_name = measurement_plugin_labels[1].split("=");
            ...
            jsonMap.put(daemonset_name[0], daemonset_name[1]);
